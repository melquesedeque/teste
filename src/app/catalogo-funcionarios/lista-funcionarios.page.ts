...
export class ListaFuncionariosPage implements OnInit {
  ...
  associados: any = [];
  constructor(private pegarId: ActivatedRoute, private rotas: Router, private menu: MenuController, private associadoService: AssociadosService, private usuarioService: UsuarioService) { }
